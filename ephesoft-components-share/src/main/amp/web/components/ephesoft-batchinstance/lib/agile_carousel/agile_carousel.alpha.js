...
(function ($) {
    ...
    $.fn.agile_carousel = function (options) {
        ...
        return this.each(function () {
            ...
            var ac_zoom_button = "";
            var ac_save_button = "";
            var ac_delete_button = "";
            var ac_duplicate_button = "";
            var ac_next_button = "";
            ...
            // Zoom Button
            //////////////////////// 
            ac_zoom_button += "<span class='zoom_button slide_button'>Zoom</span>";
            
            ////////////////////////
            // Save Button
            //////////////////////// 
            ac_save_button += "<span class='save_button slide_button'>Save</span>";
            
            ////////////////////////
            // Delete Button
            //////////////////////// 
            ac_delete_button += "<span class='delete_button slide_button'>Delete</span>";
            
            ////////////////////////
            // Duplicate Button
            //////////////////////// 
            ac_duplicate_button += "<span class='duplicate_button slide_button'>Duplicate</span>";
            ...
            ac_html += "<div class='agile_carousel' style='overflow-y: scroll;overflow-x: hidden; position: relative; width: " + carousel_outer_width + "px; height: " + carousel_outer_height + "px;'>";
            ...
            for (var key in carousel_data) {
                ...
                if (carousel_data.hasOwnProperty(key)) {
                    ...
                    if (i === 1) {
                        ac_html += "<div slide_id='"+i+"' class='slides' style='width: " + slide_width * number_of_slides + "px; height: " + slide_height + "px;'>";
                    } // if
                    if (content) {
                        // render
            ...
            var create_control_set = function (set, set_number) {
                ...
                if (set !== "") {
                    ...
                    for (j = 0; j < control_set_array.length; j++) {
                        ...
                        // zoom
                        if (control_set_array[j] == "zoom_button") {
                            control_set_html += ac_zoom_button;
                        }
                        // save
                        if (control_set_array[j] == "save_button") {
                        	control_set_html += ac_save_button;
                        }
                        // delete
                        if (control_set_array[j] == "delete_button") {
                        	control_set_html += ac_delete_button;
                        }
                        // duplicate
                        if (control_set_array[j] == "duplicate_button") {
                        	control_set_html += ac_duplicate_button;
                        }
                        // previous_button
